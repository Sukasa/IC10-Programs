...
#       - Active Vent or Volume Pump named "Air Filtration" will operate to reduce pressure, or pull stale air out to be replaced by fresher air.       #
#       - Filtration unit named "Air Filtration" will change modes to manage air filtration in concert with the above                                   #
...
#   - Activates Liquid Filtration unit named "Water Filtration" if the water loses quality due to contamination of any kind (untested)                  #
...
endmacro
  ...
  trigger 10  0       0.991   RatioWater          LiquidSensor

  # Triggers from extended mode, to move LoC around
...
macro equip_rule Index PrefabHash NameHash LogicType Condition Exclusion
  define __logic  Calc(LogicType<<EXCL_BITS_COUNT)
...
endmacro
  ...
  define FiltrationName   Hash("Air Filtration")
  define WaterFiltName    Hash("Water Filtration")
